...
module.exports = async function (context, req) {
    ...
    try {
        ...
        const focusLine = isLowSignalMessage(userQuery)
            ? [getConversationFocusInstruction(lang), yesNoLine, yesNoFollowupLine, moreInfoLine].filter(Boolean).join('\n')
            : [yesNoLine, yesNoFollowupLine, moreInfoLine].filter(Boolean).join('\n');

module.exports = async function (context, req) {
    ...
    try {
        ...
        context.res.status = 200;
        const includeRawData = String(process.env.AXILUM_VISION_INCLUDE_RAWDATA || '').trim() === '1';
        context.res.body = JSON.stringify(Object.assign({
        ...
        }, includeRawData ? { rawData: data } : null));
